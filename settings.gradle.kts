...
val forcedVersions = mapOf(
    ...
    "io.netty:netty-buffer"                            to "4.1.132.Final",
    "io.netty:netty-codec"                             to "4.1.132.Final",
    "io.netty:netty-codec-http"                        to "4.1.132.Final",
    "io.netty:netty-codec-http2"                       to "4.1.132.Final",
    "io.netty:netty-codec-socks"                       to "4.1.132.Final",
    "io.netty:netty-common"                            to "4.1.132.Final",
    "io.netty:netty-handler"                           to "4.1.132.Final",
    "io.netty:netty-handler-proxy"                     to "4.1.132.Final",
    "io.netty:netty-resolver"                          to "4.1.132.Final",
    "io.netty:netty-transport"                         to "4.1.132.Final",
    "io.netty:netty-transport-native-unix-common"      to "4.1.132.Final",
